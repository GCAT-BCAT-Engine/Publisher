...
REQUIRED_FILES = [
    ...
    Path("docs/PUBLISHER_VALIDATION_REMAINDER.md"),
    Path("docs/SOURCE_GEOMETRY_PROVENANCE.md"),
...
CHECKS = {
    Path("docs/release-gate-checklist.md"): [
        ...
        "Publisher role as citation_and_publication_surface_only",
        "source-geometry provenance note is not an activation receipt",
    ...
    Path("README.md"): [
        ...
        "The validation remainder and Issue #1 are also not activation evidence.",
        "closure evidence verification",
        "validation remainder tracking",
